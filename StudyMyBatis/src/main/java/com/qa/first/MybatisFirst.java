...
public class MybatisFirst {
    ...
    public SqlSession getSession() throws IOException {
        ...
        String resource = "MybatisConfig.xml"; //mybatis配置文件
    ...
    public void findUserById() throws IOException {
        ...
        Admin admin = sqlSession.selectOne("com.qa.po.Admin.findPasswordByAdminId", 123456);
    ...
    public void findUserByList() throws IOException {
        ...
        List<Admin> admins = sqlSession.selectList("com.qa.po.Admin.findUserByList");
    ...
    public void findUserByName() throws IOException, ParseException {
        ...
        List<Admin> list = sqlSession.selectList("com.qa.po.EtcCard.findUserByList", "浙A");
        ...
        for (Admin admin : list) {
            *//*if (etcCard.getCard_code() == null || etcCard.getCard_code().equals("")) {
            ...
            if (date.before(admin.getCreate_time())) {
                System.out.println(admin.toString());
                number +=1;
            }
        }
