...
import com.library.core.entity.ReaderCard;
import com.library.core.entity.ReaderInfo;
...
public class ReaderCardDao {
    ...
    private final static String NAMESPACE = "com.library.core.mapper.dao.ReaderCardDao.";
